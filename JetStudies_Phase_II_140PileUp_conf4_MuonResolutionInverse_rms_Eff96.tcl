...
module Efficiency MuonEfficiency {
  ...
  # efficiency formula for muons
    set EfficiencyFormula {                                    (pt <= 2.0)  * (0.00) + \  
                         (abs(eta) <= 4.00) * (pt >  2.0 && pt <= 3.0)  * (0.51*0.959) + \
                         (abs(eta) <= 4.00) * (pt >  3.0 && pt <= 4.0)  * (0.85*0.959) + \ 
                         (abs(eta) <= 4.00) * (pt >  4.0 && pt <= 11.0) * (0.93*0.959) + \               
                         (abs(eta) <= 4.00) * (pt >  11. && pt <= 50.)  * (0.96*0.959) + \   
                         (abs(eta) <= 4.00) * (pt >  50. && pt <= 70.)  * (0.98*0.959) + \                      
                         (abs(eta) <= 4.00) * (pt > 70.0 )  * (1.00*0.959) + \   
                         (abs(eta) > 4.00)  * (0.00)}
